...
### Análisis de sentimientos con el paquete TM:
```{r}
...
### Plotear los Sentimientos del paquete TM con Cantidad
...
# Sentimientos según función get_nrc_sentiment del paquete {syuzhet}
```{r}
...
method <- "nrc"
lang <- "spanish"
my_text_values <- get_sentiment(Cavero_Text, method = "method", language = "spanish")
my_text_values[1:10] #The values are the model’s assessment of the sentiment in each sentence
```
